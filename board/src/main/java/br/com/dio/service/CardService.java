...
public class CardService {
    ...
    public void moveToNextColumn(final Long cardId, final List<BoardColumnInfoDTO> boardColumnsInfo) throws SQLException{
        try{
            ...
            var dto = optional.orElseThrow(
                    () -> new EntityNotFoundException("O card id [%s] não foi encontrado".formatted(cardId))
            );
            if (dto.blocked()){
    ...
    public void block(final Long id, final String reason, final List<BoardColumnInfoDTO> boardColumnsInfo) throws SQLException {
        try{
            ...
            var dto = optional.orElseThrow(
                    () -> new EntityNotFoundException("O card id [%s] não foi encontrado".formatted(id))
            );
            if (dto.blocked()){
            ...
            if (currentColumn.kind().equals(FINAL) || currentColumn.kind().equals(CANCEL)){
                var message = "O card está em uma coluna tipo [%s] e não pode ser bloqueado"
